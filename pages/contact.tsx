...
const Contact: NextPage = () => {
  ...
  const socialLinks = [
    {
      name: 'LinkedIn',
      url: 'https://www.linkedin.com/in/prathamesh-kamble-000/',
      icon: (
    ...
    {
      name: 'GitHub',
      url: 'https://github.com/PrathameshKamble01',
      icon: (
        <svg className='w-6 h-6' fill='currentColor' viewBox='0 0 24 24'>
    ...
    {
      name: 'Medium',
      url: 'https://medium.com/@prathamesh.kamble.1221',
      icon: (
        <svg className='w-6 h-6' fill='currentColor' viewBox='0 0 24 24'>
  ...
  return (
    <>
      <Head>
        ...
        <meta name='description' content='Get in touch with Prathamesh Kamble - Full Stack Developer. Available for software engineering opportunities, collaborations, and full-time positions.' />
        <meta name='keywords' content='Prathamesh Kamble contact, Full Stack Developer hire, Pune developer, Spring Boot developer' />
            ...
            <form onSubmit={handleSubmit} className='space-y-6'>
              ...
              {submitStatus === 'error' && (
                <div className='p-4 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg'>
                  ...
                  <p className='text-red-700 dark:text-red-300 text-sm mt-1'>Please try again or contact me directly at prathamesh.kamble.1221@gmail.com</p>
                </div>
              )}
            </form>
          </div>
              ...
              <div className='space-y-4'>
                <div className='flex items-center gap-4'>
                  ...
                  <div>
                    ...
                    <p className='text-gray-600 dark:text-gray-300'>prathamesh.kamble.1221@gmail.com</p>
                  </div>
                </div>

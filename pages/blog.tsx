  ...
  return (
    <>
      ...
      <main className='min-h-screen max-w-4xl mx-auto px-4 py-12'>
            ...
            >
              ...
              >
                {post.tags.map((tag, tagIndex) => (
                  <motion.span
                    key={tag}
                    className='bg-primary/10 dark:bg-primary-dark text-primary dark:text-white px-3 py-1 rounded-full text-sm font-medium hover:bg-primary/20 dark:hover:bg-primary-dark transition-colors cursor-default' 
                    initial={{ scale: 0 }}
                    animate={{ scale: 1 }}
              ...
              >
                <motion.a
                  ...
                  className='text-primary dark:text-primary hover:text-primary-dark dark:hover:text-primary font-medium flex items-center gap-2'
        ...
        <motion.div
          className='mt-12 text-center bg-gradient-to-r from-primary/50 to-primary/50 dark:from-primary-dark/20 dark:to-primary-dark/20 rounded-lg p-8'
          initial={{ opacity: 0, y: 30 }}
